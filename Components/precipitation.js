...
<ScrollView  style={styles.container}>
    ...
    <ImageBackground  source={require('../assets/ArrierePr.png')}style={styles.action}>
    ...
    <Search/>
  <Base  
  back={require('../assets/petit-nuage.png')}
  title="Précipitation"
  unite="mm"
  />
    </ImageBackground>
    <View style={styles.temView2}>
      <View style={styles.temText5}>
        ...
        <View style={styles.temText6}>
        
        <Dashboard picture={require('../assets/nuage.png')}/>
        </View>
    </View>
